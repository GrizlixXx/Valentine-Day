const yes = document.getElementById('yes') as HTMLButtonElement;
const no = document.getElementById('no') as HTMLButtonElement;
const video = document.getElementById('video') as HTMLVideoElement;
const mask = document.getElementById('mask') as HTMLDivElement;
const heartsContainer = document.getElementById('hearts-container') as HTMLDivElement;
const container = document.querySelector('.video-container') as HTMLDivElement;
const happy = document.getElementById('happy') as HTMLDivElement;
...
const love = document.getElementById('love') as HTMLDivElement;
const love2 = document.getElementById('love2') as HTMLDivElement;
...
function makeInteractive(balloon: HTMLDivElement) {
  let offsetX = 0;
  let offsetY = 0;
...
function popBalloon(balloon: HTMLDivElement) {
